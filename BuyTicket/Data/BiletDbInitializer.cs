                ...
                if (!context.Filmler.Any())
                {
                    context.Filmler.AddRange(new List<Film>()
                    {
                        new Film()
                        {
                            ...
                            FilmBaslamaSaati1 = DateTime.Now.AddHours(2),
                            FilmBaslamaSaati2 = DateTime.Now.AddHours(5),
                            FilmBaslamaSaati3=DateTime.Now.AddHours(8),
                            SinemaId = 1,
                            YonetmenId = 2,
                        ...
                        new Film()
                        {
                            ...
                            FilmBaslamaSaati1 = DateTime.Now.AddHours(2.5),
                            FilmBaslamaSaati2 = DateTime.Now.AddHours(4),
                            FilmBaslamaSaati3=DateTime.Now.AddHours(6),
                            SinemaId = 2,
                            YonetmenId = 1,
                        ...
                        new Film()
                        {
                            ...
                            FilmBaslamaSaati1 = DateTime.Now.AddHours(1),
                            FilmBaslamaSaati2 = DateTime.Now.AddHours(3.5),
                            FilmBaslamaSaati3=DateTime.Now.AddHours(5.5),
                            SinemaId = 5,
                            YonetmenId = 5,
                            FilmKategorisi = FilmKategorisi.Komedi
                            //cem, ozan
                        ...
                        new Film()
                        {
                            ...
                            FilmBaslamaSaati1 = DateTime.Now.AddHours(1.5),
                            FilmBaslamaSaati2 = DateTime.Now.AddHours(3.5),
                            FilmBaslamaSaati3=DateTime.Now.AddHours(7),
                            SinemaId = 4,
                            YonetmenId = 5,
                        ...
                        new Film()
                        {
                            ...
                            FilmBaslamaSaati1 = DateTime.Now.AddHours(2),
                            FilmBaslamaSaati2 = DateTime.Now.AddHours(3),
                            FilmBaslamaSaati3=DateTime.Now.AddHours(5),
                            SinemaId = 2,
                            YonetmenId = 9,
                            FilmKategorisi = FilmKategorisi.Dram
                            //farah,mehmet
                        ...
                        new Film()
                        {
                            ...
                            FilmBaslamaSaati1 = DateTime.Now.AddHours(1),
                            FilmBaslamaSaati2 = DateTime.Now.AddHours(4.5),
                            FilmBaslamaSaati3=DateTime.Now.AddHours(6),
                            SinemaId = 1,
                            YonetmenId = 3,
                            FilmKategorisi = FilmKategorisi.Aksiyon
