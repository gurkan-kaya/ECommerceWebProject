...
namespace BuyTicket.Controllers
{
    public class HesapController : Controller
    {
        ...
        public HesapController(BiletDbContext context, UserManager<Kullanici> userman, SignInManager<Kullanici> signinman)
        {
            _context = context;
            _userman = userman;
        ...
        [HttpPost]
        public async Task<IActionResult> Giris(GirisVM giris)
        {
